...
- `Err(SensorError::InitializationError)` si el sensor no se encuentra.
- `Err(SensorError::InvalidData)` si los datos del archivo son inválidos.  
- `Err(SensorError::IoError)` si ocurre algún error al leer el archivo.
