...
- [Primeros Pasos](getting_started/README.md)
  - [Instalación](getting_started/installation.md)
  - [Guía Rápida](getting_started/quick_start.md)
...
- [Referencia de Sensores](sensors/README.md)
  ...
  - [DS18B20 - Temperatura OneWire](sensors/ds18b20.md)
...
- [Referencia de Interfaces](reference/README.md)
  - [core::traits](reference/core_traits.md)
    - [Sensor](reference/traits_sensor.md)
    - [Storage](reference/traits_storage.md)
    - [Communicator](reference/traits_communicator.md)
  - [core::types](reference/core_types.md)
  - [devices::sensors](reference/devices_sensors.md)
  - [storage](reference/storage.md)
  - [network](reference/network.md)
  - [drivers](reference/drivers.md)

- [Apéndices](appendices/README.md)
  - [Glosario](appendices/glossary.md)
  - [Códigos de Error](appendices/error_codes.md)
  - [Hardware Compatible](appendices/hardware.md)
